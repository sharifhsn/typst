...
pub enum DecisionReason {
    ...
    /// Legacy report value for the former pagination-preserving table raster
    /// fallback. Kept so persisted fidelity reports remain readable; new
    /// exports keep semantic tables native and may let Word reflow them.
